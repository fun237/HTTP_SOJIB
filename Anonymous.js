...
if (process.argv.length < 8){
    console.log('HTTP/2 (Support HTTPS Only) | 	https://t.me/T_GRAY_Hacker ');
...
if (headerbuilders !== undefined){
    ...
    if (cluster.isMaster){
        ...
        console.log("(!) Now Attacked | Method By https://t.me/T_GRAY_Hacker")
    ...
    if (cluster.isMaster){
        ...
        console.log("(!) Now Attacked | https://t.me/T_GRAY_Hacker")
